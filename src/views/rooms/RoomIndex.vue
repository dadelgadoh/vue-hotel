                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                <th scope="col" class="px-4 py-4">Hotel</th>
                                <th scope="col" class="px-4 py-3">Tipo de habitación</th>
                                <th scope="col" class="px-4 py-3">Acomodación</th>
                        ...
                        <tbody>
                            <tr v-for="room in rooms" :key="room.id" class="border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-3 flex items-center space-x-2">
                                    ...
                                    <button @click="destroyRoom(room.id)"
